...
const Banner = () => {
    ...
    // useState is used to define a movie state variable initialized as an empty object { }. This will hold the details of a randomly chosen movie fetched from an API.
